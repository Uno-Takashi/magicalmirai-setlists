...
export const ko: Translations = {
  ...
  'nav.newerEdition': '더 최근 연도',
  'nav.olderEdition': '더 이전 연도',
  ...
  'about.data.description': '세트리스트는 공식 사이트와 팬들이 정리한 자료를 참고했습니다.',
  'about.author': '제작자',
  ...
  'statistics.producers.title': '보카로 P별 연주 곡 수',
  'statistics.songs.title': '연주 횟수',
  'statistics.songs.help': '그 곡이 연주된 회차 수. 같은 회차에 여러 번 나와도 1회로 셉니다.',
  'statistics.vocaloids.title': '보컬로이드별 곡 수',
  'statistics.vocaloids.description': '노래한 보컬로이드별로 곡 수를 집계했습니다.',
  'statistics.vocaloids.trend.title': '회차별 곡 수',
  'statistics.vocaloids.trend.perEdition': '회차별',
  'statistics.vocaloids.trend.cumulative': '누적',
  'statistics.vocaloids.trend.perEditionHelp': '해당 회차에서 부른 곡 수입니다.',
  'statistics.vocaloids.trend.cumulativeHelp':
    '해당 회차까지 부른 곡 수입니다. 같은 곡을 다른 회차에서 다시 불러도 1곡으로 세므로 각 회차 값의 합계가 아닙니다.',
  ...
  'a11y.vocaloidTrend': '회차별 보컬로이드 곡 수 꺾은선 그래프',
  'a11y.vocaloidTrendTotal': '회차별 보컬로이드 곡 수 누적 꺾은선 그래프',
  ...
  'setlist.csv.singers': '가창',
  'setlist.csv.tags': '태그',
  'setlist.csv.shows': '공연 회차',

  'favorites.open': '즐겨찾기',
  'favorites.title': '즐겨찾기',
  'favorites.description': '담아 둔 곡을 한눈에 볼 수 있습니다',
  'favorites.empty': '아직 없습니다. 곡 오른쪽의 ＋를 누르면 여기에 모입니다',
  'favorites.close': '닫기',
  'favorites.count': '{count}곡',
  'a11y.addFavorite': '「{title}」 즐겨찾기에 추가',
  'a11y.removeFavorite': '「{title}」 즐겨찾기에서 제거',
