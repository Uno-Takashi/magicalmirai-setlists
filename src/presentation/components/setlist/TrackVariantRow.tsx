...
export function TrackVariantRow({
  ...
  return (
    // 曲を開くボタンとお気に入りのボタンを横に並べる。行全体を 1 つのボタンには
    // できない (button の入れ子は作れない) ので、押せる範囲を 2 つに分ける。
    <div className="flex items-center gap-1">
      <button
        ...
        className="group flex min-w-0 flex-1 items-baseline gap-2 rounded-lg px-2 py-1.5 text-left transition hover:bg-black/[0.04]"
      >
