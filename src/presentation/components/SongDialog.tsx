...
import { LuExternalLink, LuPictureInPicture2, LuPlay, LuX } from 'react-icons/lu'
...
export function SongDialog({
  ...
  const close = useCallback(() => {
    ...
    onClose()
  }, [inPictureInPicture, onClose, stop])
  useOverlay(song !== null, close)
              ...
              <div className="flex shrink-0 items-center gap-0.5">
                ...
                {inPictureInPicture ? (
                  <button
                    type="button"
                    onClick={onClose}
                    aria-label={t('a11y.pictureInPicture')}
